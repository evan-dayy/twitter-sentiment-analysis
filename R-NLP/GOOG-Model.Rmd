...
full_nrc = full_nrc %>% arrange(datetime)
full_nrc2 = full_nrc[41:53,]

plot(full_nrc2$datetime, full_nrc2$pred, main = "GOOG - Random Forest", xlab = "Datetime", ylab = "Price",col = 'orange', pch = 2, ylim = c(-1, 1))
...
full_nrc = full_nrc %>% arrange(datetime)
full_nrc3 = full_nrc[41:53,]

plot(full_nrc3$datetime, full_nrc1$pred, main = "GOOG - XG Boosting", xlab = "Datetime", ylab = "Price",col = 'orange', pch = 2, ylim = c(-1, 1))
